package net.soggart.alchemistcookbook.item;
...
import net.soggart.alchemistcookbook.item.custom.*;
...
public class ModItems {
    ...
    public static final Item FILLEDSYRINGEITEM = registerItem("syringe_filled", new EntityDataHolderItem(new FabricItemSettings()));
    public static final Item BLOODBOTTLE = registerItem("blood_bottle", new EntityDataHolderItem(new FabricItemSettings()));
